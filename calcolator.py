...
class Calcolator :
    def __init__(self , master):
        ...
        self.entry_value=''
        Entry(width=17 , bg='#fff' , font=('Arial Blod ' , 28), textvariable=self.equation).place(x=0 , y=0) 
    ...
    def clear(self):
         ...
         self.equation.set(self.entry_value)
    def solve(self):
        resultat=eval(self.entry_value)
        self.equation.set(resultat)

root=Tk() 
Calcolator=Calcolator(root)
root.mainloop() 